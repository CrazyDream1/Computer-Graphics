...
void cg::renderer::ray_tracing_renderer::init()
{
	...
	//lights.push_back({ float3{ 0, 1.25f, -0.03f }, float3{ 0.78f, 0.78f, 0.78f } });
	//lights.push_back({ float3{ -0.25f, 1.5f, -0.03f }, float3{ 0.78f, 0.78f, 0.78f } });
	//lights.push_back({ float3{ -0.25f, 1.f, -0.03f }, float3{ 0.78f, 0.78f, 0.78f } });
	//lights.push_back({ float3{ 0.25f, 1.f, -0.03f }, float3{ 0.78f, 0.78f, 0.78f } });
	//lights.push_back({ float3{ 0.25f, 1.5f, -0.03f }, float3{ 0.78f, 0.78f, 0.78f } });
}
